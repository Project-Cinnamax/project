        ...
        <section class="place">                                                             <!--Second section-->
            <div class="slideshow-container">
                <div class="mySlides fade">
                    ...
                    <div class="text">Cinnamon Sticks</div>
                </div>
                ...
                <div class="mySlides fade">
                    ...
                    <div class="text">Cinnamon Powder</div>
                </div>
                ...
                <div class="mySlides fade">
                    ...
                    <div class="text">Cinnamon Oil</div>
                </div>
                ...
                <div class="mySlides fade">
                    ...
                    <div class="text">Cinnamon Raws</div>
                </div>
                ...
                <div class="mySlides fade">
                    ...
                    <div class="text">Cinnamon Plants</div>
                </div>
       ...
       <div class="says-column">
        ...
        <div class="says-column">
         ...
         <div class="says-column">
            ...
            <section id ="footer">
                <div class= "text-place" >
                    <h1>TRAVELLING AROUND SRI LANKA</h1>
                </div>
...
<div class="help">
    ...
    <br>
    <div class="foot-icon">
        <i class="fa fa-home"style ='font-size:52px;color:rgb(29, 14, 117);' ></i>
    </div>
    <p class="foot-dis">
...
<br>
<div class="foot-icon">
    <i class="fa fa-map" style ='font-size:52px;color:rgb(29, 14, 117)'></i>
</div>
<p class="foot-dis">
    Touring Map to see information 
    <br> <a href="#">Find out more</a>
...
<br>
<div class="foot-icon">
    <i class="fa fa-taxi" style ='font-size:52px;color:rgb(29, 14, 117)'></i>
</div>
<p class="foot-dis">
    Find out travel times around<br>
     the country
    Times and distance
    <a href="#">
        <br>calculator</a> 
